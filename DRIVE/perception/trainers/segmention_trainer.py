...
How to train the model is specified in this python file.
Basically, this file calls the Config file and take all the steps like epochs, steps per epoch and validation data and verbose value
"""
